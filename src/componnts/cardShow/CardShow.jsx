...
export default function CardShow() {
  ...
  useEffect(() => {
    ...
    //         method: 'GET',
    //         headers: {
    //             'X-RapidAPI-Key': '00c70e864fmsh295e2826a1bb966p14cb30jsne12f4f59c15',
  ...
  return (
    ...
    <div className="w-full px-10 flex flex-col gap-5">
      ...
      <div className="flex card-cont justify-center">
        ...
        {SearchFilter.length>0 ? SearchFilter.slice(0,numCard).map((exercis) => (
            <Card key={exercis.id} exercis={exercis}></Card>
        )):
    ...
    {
        numCard < (SearchFilter.length > 0 ? SearchFilter :exercise).length && (<LoardMore load={LoadMore}></LoardMore>)
    }
